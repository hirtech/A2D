...
<script type="text/javascript">
	...
	var ajax_url = 'tasks/task_larval_surveillance_list&mode=List'+extra_url;
...
<!-- END: Page Vendor JS-->
<script src="assets/js/app_js/task_larval_surveillance.js"></script>
