            ...
            <div class="modal-body col-md-12">
                <form  id="frmadd_tasktrap" name="frmadd_tasktrap" action="" class="form-horizontal needs-validation" method="post" novalidate>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="vSiteName_tasktrap"  class="form-control " id="vSiteName_tasktrap" placeholder="Search Premise Id or Premise Name" value="{if $rs_site[0].iSiteId}{if $rs_site[0].vName neq ''}{$rs_site[0].vName|gen_strip_slash} - {/if}PremiseID# {$rs_site[0].iSiteId}{/if}"  required>
                            <input type="hidden" id="serach_iSiteId_tasktrap" name="serach_iSiteId_tasktrap" value="{$rs_site[0].iSiteId}"/>
