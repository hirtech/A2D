						...
						<ul class="nav search-links float-right">
							<li>
								<select id="vOptions" name="vOptions" class="form-control">
									...
									<option value="vPool">Pool</option>
								</select>
							</li>
							<li>
...
<script type="text/javascript">
	var ajax_url = 'lab_task/mosquito_pool_list&mode=List';
</script>
<script src="assets/js/app_js/mosquito_pool.js"></script>
