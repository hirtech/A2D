	...
	<div class="col-12 mt-1">
		<div class="card">
			...
			<div class="card-body">
				...
				<a class="btn btn-primary d-none" id="city_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post" novalidate>
                            		...
                            		<input type="hidden" name="iCityId" id="city_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vCity">City <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
	                            			<input type="text" name="vCity" id="vCity" placeholder="City Name" class="form-control" value=""  required>
...
<script type="text/javascript">
	var ajax_url = 'master/city_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}


<script src="assets/js/app_js/city.js"></script>