						...
						<ul class="nav search-links float-right">
							<li>
								<select id="vOptions" name="vOptions" class="form-control">
									<option value="vConnectionTypeName">Connection Type Name</option>
			...
			<div class="card-body">
				...
				<table id="datatable-grid" class="display table dataTable table-striped table-bordered editable-table " width="100%">
					<thead>
						<tr>
							<th width="10%">ID</th>
							<th width="40%">Connection Type Name</th>
				...
				<a class="btn btn-primary d-none" id="connection_type_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post" novalidate>
                            		...
                            		<input type="hidden" name="iConnectionTypeId" id="connection_type_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vConnectionTypeName">Connection Type <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
	                            			<input type="text" name="vConnectionTypeName" id="vConnectionTypeName" placeholder="Connection Type Name" class="form-control" value=""  required>
	                            			<div class="invalid-feedback">Please enter connection type name.</div>
	                            		</div>
                            		</div> 
                            		<div class="form-group row">
...
<script type="text/javascript">
	var ajax_url = 'master/connection_type_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}


<script src="assets/js/app_js/connection_type.js"></script>