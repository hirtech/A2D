						...
						<ul class="nav search-links float-right">
							<li>
								<select id="vOptions" name="vOptions" class="form-control">
									<option value="vSubTypeName">Sub Type</option>
				...
				<table id="datatable-grid" class="display table dataTable table-striped table-bordered editable-table " width="100%" >
					<thead>
						<tr>
							...
							<th width="10%">ID</th>
							<th width="40%">Sub Type</th>
							<th width="30%">Premise Type</th>
...
<a class="btn btn-primary d-none" id="sitesubtype_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                <!-- Modal -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal  needs-validation" method="post" novalidate>
                            		...
                            		<input type="hidden" name="iSSTypeId" id="sst_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label">Sub Type <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8"> 
                            				<input type="text" name="vSubTypeName" id="vSubTypeName" placeholder="Sub Type Name" class="form-control" value=""  required>
                            				<div class="invalid-feedback">Please enter sub type.</div>
                            			</div>
                            		</div> 
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vTypeName">Premise Type <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
	                            			<select name="iSTypeId" id="iSTypeId" class="form-control"   required>
	                            				<option value="">Select Premise Type</option>
	                            				{if $rs_sitetype|@count gt 0}
	                            					{section name=a loop=$rs_sitetype}
	                            						<option value="{$rs_sitetype[a].iSTypeId}">{$rs_sitetype[a].vTypeName}</option>
	                            					{/section}
	                            				{/if}
	                            			</select>
	                            			<div class="invalid-feedback">Please select premise type.</div>
	                            		</div>
                            		</div> 
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vTypeName">Status <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
...
<script type="text/javascript">
	var ajax_url = 'master/premise_sub_type_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}
<script src="assets/js/app_js/premise_sub_type.js"></script>
