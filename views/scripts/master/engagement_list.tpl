	...
	<div class="col-12 mt-1">
		<div class="card">
			...
			<div class="card-body">
				...
				<a class="btn btn-primary d-none" id="engagement_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post" novalidate>
                            		...
                            		<input type="hidden" name="iEngagementId" id="engagement_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vEngagement">Engagement <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
	                            			<input type="text" name="vEngagement" id="vEngagement" placeholder="Engagement Name" class="form-control" value=""  required>
	                            			<div class="invalid-feedback">Please enter engagement name.</div>
	                            		</div>
                            		</div> 
                            		<div class="form-group row">
...
<script type="text/javascript">
	var ajax_url = 'master/engagement_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}


<script src="assets/js/app_js/engagement.js"></script>