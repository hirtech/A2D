	...
	<div class="col-12 mt-1">
		<div class="card">
			...
			<div class="card-body">
				...
				<a class="btn btn-primary d-none" id="sitetype_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post"  enctype="multipart/form-data"  novalidate>
                            		<input type="hidden" name="mode" id="st_mode" value="">
                            		<input type="hidden" name="iSTypeId" id="sitetype_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="vTypeName">Premise Type <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8">
	                            			<input type="text" name="vTypeName" id="vTypeName" placeholder="Premise Type Name" class="form-control" value=""  required>
	                            			<div class="invalid-feedback">Please enter Premise Type.</div>
	                            		</div>
                            		</div> 
                            		<div class="form-group row">
                            		...
                            		<div class="form-group row">
                            			<label class="col-sm-4 col-form-label" for="iStatus">Icon <span class="text-danger"> *</span></label>
                            			<div class="col-sm-8 d-inline-flex">
                            				 <input type="file" class="d-inline-flex form-control-file" id="siteIcon" name="icon_url" >
                            				 <span id="icon_image"></span>
                            				 <input type="hidden" name="icon_url_old" id="siteIcon_old" value="">
                            			</div> 
                            		</div>
                            	</form>
                            </div>
...
<script type="text/javascript">
	var ajax_url = 'master/premise_type_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}
<script src="assets/js/app_js/premise_type.js"></script>