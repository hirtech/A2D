						...
						<ul class="nav search-links float-right">
							<li>
								<select id="vOptions" name="vOptions" class="form-control">
									<option value="vAttribute">Premise Attribute</option>
				...
				<table id="datatable-grid" class="display table dataTable table-striped table-bordered editable-table">
					<thead>
						<tr>
							...
							<th  width="10%">ID</th>
							<th  width="50%">Premise Attribute</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-md-12">
            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post" novalidate>
            		<input type="hidden" name="mode" id="sattr_mode" value="">
            		<input type="hidden" name="iSAttributeId" id="siteattr_id" value="">
            		<div class="form-group row">
            			<label class="col-sm-4 col-form-label" for="vAttribute">Premise Attribute<span class="text-danger"> *</span></label>
            			<div class="col-sm-8">
                			<input type="text" name="vAttribute" id="vAttribute" placeholder="Premise Attribute" class="form-control" value=""  required>
                			<div class="invalid-feedback">Please enter premise attribute.</div>
                		</div>
            		</div> 
            		<div class="form-group row">
            			<label class="col-sm-4 col-form-label" for="">Status <span class="text-danger"> *</span></label>
            			<div class="col-sm-8">
...
<script type="text/javascript">
	var ajax_url = 'master/premise_attribute_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}

<script src="assets/js/app_js/premise_attribute.js"></script>