						...
						<ul class="nav search-links float-right">
							<li>
								<select id="vOptions" name="vOptions" class="form-control">
									<option value="iEquipmentManufacturerId">ID</option>
									<option value="vEquipmentManufacturer">Equipment Manufacturer</option>
			...
			<div class="card-body">
				...
				<table id="datatable-grid" class="display table dataTable table-striped table-bordered editable-table">
					<thead>
						<tr>
							<th width="10%">ID</th>
							<th width="40%">Equipment Manufacturer</th>
				...
				<a class="btn btn-primary d-none" id="equipment_manufacturer_box" data-toggle="modal" href="#exampleModaltooltip">launch model</a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body col-md-12">
                            	<form  id="frmadd" name="frmadd" action="" class="form-horizontal needs-validation" method="post" novalidate>
                            		...
                            		<input type="hidden" name="iEquipmentManufacturerId" id="equipment_manufacturer_id" value="">
                            		<div class="form-group row">
                            			<label class="col-sm-5 col-form-label" for="vEquipmentManufacturer">Equipment Manufacturer <span class="text-danger"> *</span></label>
                            			<div class="col-sm-7">
	                            			<input type="text" name="vEquipmentManufacturer" id="vEquipmentManufacturer" placeholder="Equipment Manufacturer" class="form-control" value=""  required>
	                            			<div class="invalid-feedback">Please enter Equipment Manufacturer name.</div>
	                            		</div>
                            		</div> 
                            		<div class="form-group row">
                            			<label class="col-sm-5 col-form-label" for="iStatus">Status <span class="text-danger"> *</span></label>
                            			<div class="col-sm-7 ">
...
<script type="text/javascript">
	var ajax_url = 'master/equipment_manufacturer_list?mode=List';
	var access_group_var_add = '{$access_group_var_add}';
</script>
{include file="general/dataTables.tpl"}


<script src="assets/js/app_js/equipment_manufacturer.js"></script>