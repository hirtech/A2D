	          ...
	          <div class="form-row">
	          	<div class="form-group col-md-12">
	               <select name="iSTypeId" id="iSTypeId" class="form-control">
						<option value="">-- Select --</option>
						{section name="z" loop=$rs_site_type}
						<option value="{$rs_site_type[z].iSTypeId}">{$rs_site_type[z].vTypeName|gen_strip_slash}</option>
						{/section}
					</select>
				</div>
	          </div>
	        ...
	        <div class="form-group col-md-4">
	          ...
	          <div class="form-row">
	            ...
	            <select name="iSSTypeId" id="iSSTypeId" class="form-control col-md-12">
					<option value="">-- Select --</option>
					{section name="z" loop=$rs_site_sub_type}
					<option value="{$rs_site_sub_type[z].iSSTypeId}">{$rs_site_sub_type[z].vSubTypeName|gen_strip_slash}</option>
					{/section}
				</select>
				</div>
	          </div>
