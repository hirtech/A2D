    ...
    var handleData =function(){
        gridtable = $('#datatable-grid').DataTable({  
            "processing": true,
                ...
                'bAutoWidth': true,
                "columns": [
                    { "data": "iInvoiceId", "sortable":true, "className": "text-center"},
                    ...
                    { "data": "BillingMonth", "sortable":true, "className": "text-center"},
                    { "data": "rTotalAmount", "sortable":true, "className": "text-right"},
