        ...
        gridtable = $('#datatable-grid').DataTable({  
            "processing": true,
                ...
                "columns": [
                    ...
                    { "data": "vConnectionTypeName", "sortable":true, "width" : "50%"},
...
function addEditData(id,mode){
    ...
    if(mode == "edit"){
        $("#stmodaltitle").html('Edit Connection Type');
        $("#st_mode").val('Update');
        $("#connection_type_id").val(id);
        $("#vConnectionTypeName").val($("#connection_type_name_"+id).val());
       
        var status = $("#connection_type_status_"+id).val();
        if(status == "Active"){
        ...
        $("#stmodaltitle").html('Add Connection Type');
        $("#st_mode").val('Add');
        $("#iConnectionTypeId").val('');
        $("#vConnectionTypeName").val('');
        $("#iStatus").prop('checked',true).change();
    }
    $("#connection_type_box").trigger('click');
}
...
$("#save_data").click(function(){
    ...
    if(isError == 0){
        ...
        $.ajax({
            type: "POST",
            url: site_url+"master/connection_type_list",
            data: data_str,
