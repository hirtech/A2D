$(document).ready(function() {
    ...
    var cluster = new Bloodhound({
        ...
        remote: {
            url: site_url+'maintenance_ticket/maintenance_ticket_add?mode=search_premise',
    ...
    var clusterSO = new Bloodhound({
        ...
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        remote: {
            url: site_url+'maintenance_ticket/maintenance_ticket_add?mode=search_service_order',
            replace: function(url, uriEncodedQuery) {
...
function onPremiseClusteSelected(e, datum){
    ...
    str += '<tr>';
        ...
        str += '<td><input type="date" class="form-control" name="dMaintenanceStartDate[]" value="'+dTodayDate+'"></td>';
    ...
    str += '</tr>';
    //alert(maintenance_ticket_premise_count)
    if(str !='') {
    ...
    maintenance_ticket_premise_count++;
    $("#premise_length").val(maintenance_ticket_premise_count)
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(response['error'] == "0"){
                    ...
                    setTimeout(function () { location.href = site_url+'maintenance_ticket/maintenance_ticket_list';}, 3500);
