...
$access_group_var_CSV = per_hasModuleAccess("Trouble Ticket", 'CSV', 'N');
...
if($mode == "List"){
    ...
    include_once($class_path.'PHPExcel/PHPExcel.php'); 
        ...
        $file_name = "trouble_ticket_".time().".xlsx";
        ...
        if($cnt_export >0) {
            ...
            for($e=0; $e<$cnt_export; $e++) {
                ...
                $objPHPExcel->getActiveSheet()
                        ->setCellValue('A'.($e+2), $rs_export[$e]['iTroubleTicketId'])
            ...
            // Rename worksheet
            $objPHPExcel->getActiveSheet()->setTitle('TroubleTicket');
