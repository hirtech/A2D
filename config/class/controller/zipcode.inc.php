...
class Zipcode {
	...
	function recordset_list()
	{
		...
		$sql = "SELECT zipcode_mas.* ".$this->join_field_str." FROM zipcode_mas".$this->join_clause.$this->where_clause.$this->group_by_clause.$this->order_by_clause.$this->limit_clause;
	...
	function recordset_total()
	{
		...
		$sql = "SELECT zipcode_mas.\"iZipcode\" ".$this->join_field_str." FROM zipcode_mas".$this->join_clause.$this->where_clause.$this->group_by_clause;
		//$rs_db = $sqlObj->GetAll($sql);
		//return count($rs_db);
