...
class AgentMosquito {
	...
	function recordset_list()
	{
		...
		$sql = "SELECT agent_mosquito.* ".$this->join_field_str." FROM agent_mosquito ".$this->join_clause.$this->where_clause.$this->group_by_clause.$this->order_by_clause.$this->limit_clause;
		//echo $sql;exit();
	...
	function recordset_total()
	{
		...
		$sql = "SELECT agent_mosquito.* ".$this->join_field_str." FROM agent_mosquito ".$this->join_clause.$this->where_clause.$this->group_by_clause;
		//$rs_db = $sqlObj->GetAll($sql);
		//return count($rs_db);
