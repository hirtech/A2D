...
class PremiseCircuit {
	...
	function add_records(){
		...
		if($this->insert_arr){
			$sql = "INSERT INTO premise_circuit(\"iWOId\",\"iPremiseId\", \"iCircuitId\", \"dAddedDate\", \"iConnectionTypeId\", \"iStatus\")VALUES ('".$this->insert_arr['iWOId']."','".$this->insert_arr['iPremiseId']."', '".$this->insert_arr['iCircuitId']."', ".gen_allow_null_char(date_getSystemDateTime()).", '".$this->insert_arr['iConnectionTypeId']."', '".$this->insert_arr['iStatus']."')";
			//echo $sql;exit;
			$sqlObj->Execute($sql);
