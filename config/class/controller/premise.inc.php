			...
			//echo $iPremiseId;exit();
	 		if($iPremiseId){
	 			...
	 			if($iFiberInquiryId > 0){
	 				$sql_fI = "UPDATE fiberinquiry_details set \"iMatchingPremiseId\" = '".$iPremiseId."' WHERE \"iFiberInquiryId\" = '".$iFiberInquiryId."'";
