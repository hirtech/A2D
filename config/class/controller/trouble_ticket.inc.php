...
class TroubleTicket {
	...
	{	global $sqlObj;
		...
		$sql_glance =  "select (SELECT count(\"iTroubleTicketId\")  from  trouble_ticket ".$where_clause1." ) as ttcount1 , ( SELECT  count(\"iTroubleTicketId\") from  trouble_ticket ".$where_clause2." ) as ttcount2 ";
