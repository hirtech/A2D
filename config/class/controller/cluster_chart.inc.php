...
class ClusterChart {
	...
	function recordset_list()
	{
		...
		$sql = "SELECT clustered_chart.* ".$this->join_field_str." FROM clustered_chart ".$this->join_clause.$this->where_clause.$this->group_by_clause.$this->order_by_clause.$this->limit_clause;
		//echo $sql;exit;
