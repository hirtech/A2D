...
class PieChart {
	...
	function recordset_list()
	{
		...
		$sql = "SELECT pie_charts.* ".$this->join_field_str." FROM pie_charts".$this->join_clause.$this->where_clause.$this->group_by_clause.$this->order_by_clause.$this->limit_clause;
		//echo $sql;exit;
