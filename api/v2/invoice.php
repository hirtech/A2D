...
if($request_type == "invoice_list"){
    ...
    if(!empty($premise_where_arr)) {
        ...
        $premise_join_arr[] = 'LEFT JOIN premise_mas s on invoice_lines."iPremiseId" = s."iPremiseId"';
    ...
    if($rs_invoice) {
        ...
        $join_arr[] = 'LEFT JOIN premise_mas s ON invoice_lines."iPremiseId" = s."iPremiseId"';
